# Compila relatorio.tex na raiz deste laboratório (duas passagens).
...
if (-not $pdflatex) {
    Write-Host "pdflatex nao encontrado. Use: python setup_miktex_path.py" -ForegroundColor Yellow
    exit 1
}
